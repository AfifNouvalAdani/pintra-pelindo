...
Future<Map<String, dynamic>?> _checkActiveBooking() async {
  ...
  // Menu items - LOGIKA DIPERBAIKI!
    List<DashboardMenuItem> get menus {
      ...
      if (widget.role == 'user') {
        // ✅ FIX: Gunakan _isManagerDivisi, BUKAN _userJabatan == 'Manager'
        if (_isManagerDivisi) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.role != 'user' || (widget.role == 'user' && _userJabatan == 'Manager')) ...[
              Row(
                children: [
